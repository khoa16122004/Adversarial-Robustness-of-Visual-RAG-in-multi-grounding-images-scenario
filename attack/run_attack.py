...
if __name__ == "__main__":
    ...
    parser.add_argument("--reader_name", type=str)
    ...
    parser.add_argument("--F", type=float, default=0.9, help="Differential weight for mutation")
    ...
    parser.add_argument("--std", type=float, default=0.05, help="Standard deviation for initialization")
